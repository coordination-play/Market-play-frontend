import { Box, SimpleGrid, GridItem, Text, Heading, VStack, Divider, HStack } from "@chakra-ui/react";
...
export default function CampaignDetails() {
    ...
    const campaignData = {
        ...
        campaignDescription: "A campaign to increase awareness of our spring collection.",
    ...
    return (
        <Box bg="#edf3f8" _dark={{ bg: "#111" }} p={20} minH="100vh" w={"full"}>
            <HStack>
                <Heading fontSize="3xl" fontWeight="medium" mb={4} textAlign="left" color={"purple"}>
                    Campaign Details
                </Heading>
