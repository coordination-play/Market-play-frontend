...
export const useCreateOrganisationContract = () => {
  ...
  const { contract } = useContract({
    abi: OrganisationABI,
    address: CONTRACTS_ADDRESSES.ORGANISATION_TESTNET,
    provider,
  });
  ...
  const createOrganisation = async ({
    ...
    //   }
      ...
      const multiCall = await account.execute([
        ...
        {
          contractAddress: CONTRACTS_ADDRESSES.ORGANISATION,
          ...
          calldata: CallData.compile({
            ...
            metadata: shortString.splitLongString(description),
            start_time: startDate,
            duration: endDate,
            token_address: tokenAddress,
            token_amount: budgetAllocation,
          }),
        },
      ]);
